 ...
 */
class OpenCompetitionReport extends ReportAbstract {

    const XML_TEMPLATE = 'ZakupkiBundle:Consumer/Notice:open_competition_xml.html.twig';
    const XSD_TEMPLATE = 'ZakupkiBundle:Consumer/Notice:open_competition_xsd.html.twig';
